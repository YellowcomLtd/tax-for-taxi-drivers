---
title: "State Pension forecasts & NIC checks for taxi drivers"
shortTitle: "Pensions & NIC"
description: "State Pension forecasts and National Insurance contribution checks for self-employed taxi drivers in Belfast and Northern Ireland."
icon: "🏦"
order: 5
card: true
...
- Drivers in their 40s and 50s who haven't checked their NIC record in years
- Anyone with gaps after illness, time abroad, or years below the NIC thresholds
- Drivers planning to reduce hours and wanting a clear picture first
- Clients already on [Self Assessment](/services/self-assessment) with us who want the pension piece tied in

Read more in our insight: [State Pension forecasts for self-employed drivers](/insights/state-pension-forecasts-for-self-employed-drivers).
...
## How this links to your tax work

Your Self Assessment profits drive Class 4 NIC. Keeping returns accurate and on time protects both your tax position and your contribution record. If HMRC letters mention NIC or pension-related issues, we can fold that into the same conversation as [penalty appeals](/services/hmrc-penalty-appeals) or general support.

## Talk to us

[Ring for a confidential chat](/contact), or [refer a mate](/#refer) and earn £50 when they join.